...
backup-reminderbot:
	docker stop telegram-reminderbot_reminderbot_1 telegram-reminderbot-db-1
	...
	docker start telegram-reminderbot_reminderbot_1 telegram-reminderbot-db-1

backup-modbot:
	docker stop telegram-modbot_modbot_1 telegram-modbot-db-1
	...
	docker start telegram-modbot_modbot_1 telegram-modbot-db-1
